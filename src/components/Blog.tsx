  ...
  return (
    <section id="blog-section" className="max-w-7xl mx-auto w-full px-4 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/blog/co-nen-mua-nha-hai-chau" className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all group block">
        ...
        <Link href="/blog/kinh-nghiem-mua-dat-son-tra" className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all group block">
        ...
        <Link href="/blog/nha-kiet-o-to-la-gi" className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all group block">
